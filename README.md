...
Using SQLiteStudio is highly recommended. This excellent opensource interface can be [downloaded here](https://sqlitestudio.pl/). 
...
* Python scripts that parse and load BIS data into SQLite (required)
...
* R script for data analysis (optional)
